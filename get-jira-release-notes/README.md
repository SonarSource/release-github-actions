...
| `issue-types`       | Comma-separated list of issue types to include in the release notes, in order. Includes deprecated Jira issue types for backwards compatibility.                                                                                 | No       | `Feature,New Feature,False Positive,False Negative,Bug,Improvement,Security` |
